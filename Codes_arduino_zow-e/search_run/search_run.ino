...
int IRstate1 = 0;
int IRstate2 = 0;
int IRstate_Li_ar1 = 0;
int IRstate_Li_ar2 = 0;
...
void setup() {
  ...
  pinMode(IR1, INPUT);
  pinMode(IR2, INPUT);
  pinMode(Li_ar1, INPUT);
  pinMode(Li_ar2, INPUT);
  delay(5000); 
}
void loop() {
  ...
  IRstate_Li_ar1=digitalRead(Li_ar1);
  IRstate_Li_ar2=digitalRead(Li_ar2);

  if(IRstate_Li_ar1 == 1 || IRstate_Li_ar2 == 1)
  {
    advance(100,100);
  }
  else
